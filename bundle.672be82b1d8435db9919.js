...
var PopUpInfoWindowExample = function (_Component) {
  _inherits(PopUpInfoWindowExample, _Component);
  ...
  function PopUpInfoWindowExample() {
    ...
    _classCallCheck(this, PopUpInfoWindowExample);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = PopUpInfoWindowExample.__proto__ || Object.getPrototypeOf(PopUpInfoWindowExample)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      center: {
        lat: -25.363882,
        lng: 131.044922
      },
    ...
    }, _this.handleMarkerClick = _this.handleMarkerClick.bind(_this), _this.handleMarkerClose = _this.handleMarkerClose.bind(_this), _temp), _possibleConstructorReturn(_this, _ret);
  }

  _createClass(PopUpInfoWindowExample, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(PopUpInfoWindowExampleGoogleMap, {
        containerElement: _react2.default.createElement("div", { style: { height: 500 } }),
...
var _select_bar = __webpack_require__(231);

var _select_bar2 = _interopRequireDefault(_select_bar);

var _google_map = __webpack_require__(230);

var _google_map2 = _interopRequireDefault(_google_map);

var _directions = __webpack_require__(131);
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_select_bar2.default, null),
...
var _location_coord = __webpack_require__(234);

var _location_coord2 = _interopRequireDefault(_location_coord);

var _driver_details = __webpack_require__(233);

var _driver_details2 = _interopRequireDefault(_driver_details);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var rootReducer = (0, _redux.combineReducers)({
  center: _location_coord2.default,
  driverdetails: _driver_details2.default
});
...
var DriverMarkers = function (_Component) {
  _inherits(DriverMarkers, _Component);

  function DriverMarkers(props) {
    _classCallCheck(this, DriverMarkers);

    var _this = _possibleConstructorReturn(this, (DriverMarkers.__proto__ || Object.getPrototypeOf(DriverMarkers)).call(this, props));

    _this.state = { driverdetails: _this.props.driverdetails };
  ...
  _createClass(DriverMarkers, [{
    key: "driverMarkers",
    value: function driverMarkers() {
      var _this2 = this;

      if (this.props.Zoom > 13) {
        return this.state.driverdetails.map(function (marker, index) {
          return _react2.default.createElement(
            _lib.Marker,
            {
              key: index,
            ...
            marker.showInfo && _react2.default.createElement(
              _lib.InfoWindow,
              { onCloseClick: function onCloseClick() {
                  return _this2.handleMarkerClose(marker);
                } },
              _react2.default.createElement(
                "div",
                null,
    ...
    value: function handleMarkerClick(targetMarker) {
      this.setState({
        driverdetails: this.state.driverdetails.map(function (marker) {
          if (marker === targetMarker) {
            return _extends({}, marker, {
              showInfo: true
            });
...
exports.default = (0, _reactRedux.connect)(mapStateToProps)(DriverMarkers);
...
var _canUseDom = __webpack_require__(248);

var _canUseDom2 = _interopRequireDefault(_canUseDom);

var _reactRedux = __webpack_require__(34);

var _raf = __webpack_require__(323);
...
var _MarkerClusterer = __webpack_require__(337);

var _MarkerClusterer2 = _interopRequireDefault(_MarkerClusterer);

var _driver_markers = __webpack_require__(229);

var _driver_markers2 = _interopRequireDefault(_driver_markers);
...
var GDMGoogleMap = (0, _lib.withGoogleMap)(function (props) {
  return _react2.default.createElement(
    _lib.GoogleMap,
    {
      defaultZoom: 12,
    ...
    _react2.default.createElement(_driver_markers2.default, { Zoom: props.Zoom }),
    props.directions && _react2.default.createElement(_lib.DirectionsRenderer, { directions: props.directions })
  );
});
...
var GeolocationExample = function (_Component) {
  ...
  function GeolocationExample(props) {
    _classCallCheck(this, GeolocationExample);

    var _this = _possibleConstructorReturn(this, (GeolocationExample.__proto__ || Object.getPrototypeOf(GeolocationExample)).call(this, props));
  ...
  _createClass(GeolocationExample, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        "div",
        null,
        _react2.default.createElement(GDMGoogleMap, {
          containerElement: _react2.default.createElement("div", { style: { height: 500 } }),
          mapElement: _react2.default.createElement("div", { style: { height: "100%" } }),
          center: this.state.center,
...
exports.default = (0, _reactRedux.connect)(mapStateToProps)(GeolocationExample);
...
var SelectBar = function (_Component) {
  _inherits(SelectBar, _Component);

  function SelectBar(props) {
    _classCallCheck(this, SelectBar);

    var _this = _possibleConstructorReturn(this, (SelectBar.__proto__ || Object.getPrototypeOf(SelectBar)).call(this, props));

    _this.state = { location: '0' };
    return _this;
  }

  _createClass(SelectBar, [{
    key: 'onSelectChange',
    value: function onSelectChange(location) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'select',
          { className: 'form-control', value: this.state.location, onChange: function onChange(event) {
              return _this2.onSelectChange(event.target.value);
            } },
          _react2.default.createElement(
            'option',
            { value: '0' },
...
function mapDispatchToProps(dispatch) {
  return (0, _redux.bindActionCreators)({ selectLocation: _index.selectLocation }, dispatch);
}

exports.default = (0, _reactRedux.connect)(null, mapDispatchToProps)(SelectBar);
...
exports.default = function () {
  return [{ id: 1, lat: 25.042363, lng: 121.535385, DriverId: 879595, DriverName: "張偉誠", License: "GX-106", showInfo: false }, { id: 2, lat: 25.040234, lng: 121.537655, DriverId: 551404, DriverName: "王彥帆", License: "FF-203", showInfo: false }, { id: 3, lat: 25.040205, lng: 121.533471, DriverId: 161411, DriverName: "蔡幼志", License: "QU-797", showInfo: false }, { id: 4, lat: 25.042975, lng: 121.530209, DriverId: 506970, DriverName: "黃坤琦", License: "EB-072", showInfo: false }, { id: 5, lat: 25.046173, lng: 121.530037, DriverId: 504289, DriverName: "羅珈禮", License: "UI-144", showInfo: false }, { id: 6, lat: 25.045745, lng: 121.535777, DriverId: 471384, DriverName: "陳淑奇", License: "SM-552", showInfo: false }, { id: 7, lat: 25.040593, lng: 121.529136, DriverId: 861767, DriverName: "蔣辛堅", License: "BR-752", showInfo: false }, { id: 8, lat: 25.046124, lng: 121.537065, DriverId: 840591, DriverName: "蔡哲宇", License: "IE-4996", showInfo: false }, { id: 9, lat: 25.043593, lng: 121.524867, DriverId: 538784, DriverName: "林于禮", License: "AK-199", showInfo: false }, { id: 10, lat: 25.037996, lng: 121.539167, DriverId: 320193, DriverName: "王俊豪", License: "VI-039", showInfo: false }, { id: 11, lat: 25.035611, lng: 121.557514, DriverId: 235962, DriverName: "賴耿為", License: "UY-616", showInfo: false }, { id: 12, lat: 25.032909, lng: 121.566773, DriverId: 502932, DriverName: "羅彥志", License: "LZ-801", showInfo: false }, { id: 13, lat: 25.028525, lng: 121.568296, DriverId: 547993, DriverName: "郭采劭", License: "UC-621", showInfo: false }, { id: 14, lat: 25.038101, lng: 121.568405, DriverId: 846021, DriverName: "吳雅玲", License: "LR-224", showInfo: false }, { id: 15, lat: 25.040891, lng: 121.564307, DriverId: 794634, DriverName: "李宗霖", License: "RY-517", showInfo: false }, { id: 16, lat: 25.037790, lng: 121.554211, DriverId: 263257, DriverName: "陳建如", License: "BJ-591", showInfo: false }, { id: 17, lat: 25.027041, lng: 121.555668, DriverId: 683298, DriverName: "張志湖", License: "KZ-334", showInfo: false }, { id: 18, lat: 25.033071, lng: 121.560529, DriverId: 448473, DriverName: "林宗翰", License: "TP-996", showInfo: false }, { id: 19, lat: 25.034724, lng: 121.563501, DriverId: 620989, DriverName: "劉育軍", License: "GF-444", showInfo: false }, { id: 20, lat: 25.038183, lng: 121.557516, DriverId: 819434, DriverName: "陳志偉", License: "KF-881", showInfo: false }, { id: 21, lat: 25.037983, lng: 121.543943, DriverId: 686137, DriverName: "蔣弘亨", License: "YE-129", showInfo: false }, { id: 22, lat: 25.041208, lng: 121.543779, DriverId: 128280, DriverName: "顏孟倫", License: "XN-377", showInfo: false }, { id: 23, lat: 25.045192, lng: 121.513189, DriverId: 192393, DriverName: "羅宗翰", License: "KT-724", showInfo: false }, { id: 24, lat: 25.046154, lng: 121.517277, DriverId: 174463, DriverName: "陸平盈", License: "OG-465", showInfo: false }, { id: 25, lat: 25.048496, lng: 121.513307, DriverId: 868941, DriverName: "張家真", License: "ZH-266", showInfo: false }, { id: 26, lat: 25.043086, lng: 121.518925, DriverId: 506686, DriverName: "陳俊映", License: "QI-952", showInfo: false }];
};
...
/* WEBPACK VAR INJECTION */(function(global) {var now = __webpack_require__(321)
...
var _flowRight2 = __webpack_require__(8);
...
var _markerClustererPlus = __webpack_require__(320);

var _markerClustererPlus2 = _interopRequireDefault(_markerClustererPlus);

var _constants = __webpack_require__(7);

var _enhanceElement = __webpack_require__(10);
